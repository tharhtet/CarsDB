...
class WelcomeViewController: BaseViewController, Storyboarded {
    ...
    var slides: [SlideModel] = [
        SlideModel(title: "Cars around you", desc: "5,000 cars to use from a few hours to a few days", image: "image_j1"),
        SlideModel(title: "Live Ride Tracking", desc: "Know your driver in advance and be able to view current location in real time on the map.", image: "image_j2"),
        SlideModel(title: "Ready to go", desc: "If it's a CarLite, you can unlock it with your phone. Easy-peasy.", image: "image_j3")
    ]
